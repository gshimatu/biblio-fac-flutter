...
class ProfileAdminDetailsView extends StatefulWidget {
  const ProfileAdminDetailsView({super.key});

  @override
  State<ProfileAdminDetailsView> createState() => _ProfileAdminDetailsViewState();
}

class _ProfileAdminDetailsViewState extends State<ProfileAdminDetailsView> {
